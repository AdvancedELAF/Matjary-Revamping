$(document).ready(function(){
    ...
    /* sai code */
    $(".item").on("click",".addToCart", function() { 
        let _self = $(this); 
        ...
        ({
            ...
            success: function(resp){  /* A function to be called if request succeeds */
                ...
                if(respData.responseCode == 200){
                    ...
                    $(".product_"+productid+"_cartBtn").html('<a href="javascript:void(0);" data-baseurl="'+baseurl+'" data-actionurl="'+removeProductFromCartUrl+'" data-productid="'+productid+'" data-customerid="'+customerid+'" data-lang="'+locale+'" class="brand-btn-add-cart removeFromCart">'+RemoveFromCart+'</a>');
                }else{
                    swal({title: "", text: respData.responseMessage, type: "error"});
                }
            }
    ...
    $(".item").on("click",".removeFromCart", function() { 
        let _self = $(this);
        let baseurl = $(this).data('baseurl');
        ...
        ({
            ...
            success: function(resp){  /* A function to be called if request succeeds */
                ...
                if(respData.responseCode == 200){
                    ...
                    $(".product_"+productid+"_cartBtn").html('<a href="javascript:void(0);" data-baseurl="'+baseurl+'" data-actionurl="'+addProductFromCartUrl+'" data-productid="'+productid+'" data-customerid="'+customerid+'" data-lang="'+locale+'" class="brand-btn-add-cart addToCart">'+AddToCart+'</a>');
                }else{
                    swal({title: "", text: respData.responseMessage, type: "error"});
                }
            }
    ...
    $("#productCartBox").on("click",".addToWishlist", function() { 
        ...
        ({
            ...
            success: function(resp){  /* A function to be called if request succeeds */
                ...
                if(respData.responseCode == 200){
                    swal.close();
                    $("#product_"+productid+"_whishlistBtn").html('<a href="javascript:void(0);" data-baseurl="'+baseurl+'" data-actionurl="'+removeProductFromWishlistUrl+'" data-productid="'+productid+'" data-customerid="'+customerid+'" class="brand-btn-add-wishlist removeFromWishlist">'+RemoveFromWhishlist+'</a>');
                }else{
                    swal({title: "", text: respData.responseMessage, type: "error"});
                }
            }
    ...
    $("#productCartBox").on("click",".removeFromWishlist", function() { 
        ...
        ({
            ...
            success: function(resp){  /* A function to be called if request succeeds */
                ...
                if(respData.responseCode == 200){                  
                    swal.close();
                    $("#product_"+productid+"_whishlistBtn").html('<a href="javascript:void(0);" data-baseurl="'+baseurl+'" data-actionurl="'+addProductToWishlistUrl+'" data-productid="'+productid+'" data-customerid="'+customerid+'" data-lang="'+locale+'" class="brand-btn-add-wishlist addToWishlist">'+wishlist+'</a>');
                }else{
                    swal({title: "", text: respData.responseMessage, type: "error"});
                }
            }
                                ...
                                if(isCheckoutPage==1){
                                    ...
                                    $.each(customerAddressList,function(key, value){
                                        ...
                                        var html_content = '<div class="checkout-wrapper">'+
                                            ...
                                            '</div>'+
                                            '<p class="error1"></p>'+
                                            '<a href="javascript:void(0);" class="brand-btn-orange '+mrml+' editMyAddress" data-customerid="'+value.customer_id+'" data-actionurl="'+base_url+'/customer/edit-customer-deliver-address" data-id="'+value.id+'">'+EditBtn+'</a>'+
                                            '<a href="javascript:void(0);" class="brand-btn-black removeMyAddressbtn" id="rempveAddress" data-actionurl="'+base_url+'/customer/delete-customer-deliver-address" data-id="'+value.id+'" data-operation="delete"><i class="dw dw-delete-3"></i> '+DeleteBtn+'</a>'+
                                        '</div>';
        ...
        if(this.checked) {     
            $(".cartItemsTr .product_qty").each(function() {
                ...
                if(cartItemChk=='' || cartItemChk==undefined || cartItemChk==null){
                    ...
                    sales_taxs_span =  parseFloat(sales_taxs_span) + parseFloat(qty_sales_tax);
                    $("#sales_taxs_span").text(sales_taxs_span.toFixed(2));
                }                
                
            });

        }else{
            $("#sales_taxs_span").text('0.00');
            $("#subtotal_span").text('0.00');
            $("#subtotal").val('');
            $("#coupon_code").val('');
    ...
    $("div#cartItemsTbody").on("click","#rempveSnglProdFromCart", function(e) { 
        e.preventDefault();
    ...
    $(".cat-tab-item").click(function (e) {
        ...
        ({
            ...
            success: function(resp){  /* A function to be called if request succeeds */
                ...
                swal.close();
                if(respData.responseCode == 200){
                    let html_content = '<div class="owl-stage-outer" ><div class="owl-stage">';
                    if(typeof respData.responseData !== 'undefined'){
                        ...
                        $.each(productList,function(key, value){
                            ...
                            var discount_per = parseFloat(value.discount_per);
                            ...
                            if(customerid != ''){
                                var actionPrdctCarturl = base_url+'/customer/add-product-cart';
                                var actionCartBtnClass = 'addToCart';
                                var anchorCartBtnText = (lang == "en") ? "أضف إلى السلة" : "Add to Cart";
                                if(already_incart==true){
                                    var actionPrdctCarturl = base_url+'/customer/remove-product-cart';
                                    var actionCartBtnClass = 'removeFromCart';
                                    var anchorCartBtnText = (lang == "en") ? "إزالة من عربة التسوق": "Remove from Cart";
                                }

                            Addtocart =  '<span class="product_'+product_id+'_cartBtn" ><a href="javascript:void(0);" data-baseurl="'+base_url+'" data-actionurl="'+ actionPrdctCarturl +'" data-productid="'+product_id+'" data-customerid="'+customerid+'"  data-lang="'+lang+'" class="brand-btn-add-cart '+actionCartBtnClass+'">'+anchorCartBtnText+'</a></span>';
    ...
    $("section.section-spacing").on("click",".addToCart", function(e) {
        let _self = $(this); 
        let baseurl = $(this).data('baseurl');
        let removeProductFromCartUrl = baseurl+'/customer/remove-product-cart';
        let actionurl = $(this).data('actionurl');
        ...
        ({
            ...
            success: function(resp){  /* A function to be called if request succeeds */
                ...
                if(respData.responseCode == 200){
                    ...
                    $(_self).closest(".product_"+productid+"_cartBtn").html('<a href="javascript:void(0);" data-baseurl="'+baseurl+'" data-actionurl="'+removeProductFromCartUrl+'" data-productid="'+productid+'" data-customerid="'+customerid+'" data-lang="'+locale+'" class="brand-btn-add-cart removeFromCart">'+RemoveFromCart+'</a>');
                }else{
                    swal({title: "", text: respData.responseMessage, type: "error"});
                }
            }
    ...
    $("section.section-spacing").on("click",".removeFromCart", function(e) {
        let _self = $(this);
        let baseurl = $(this).data('baseurl');
        let addProductFromCartUrl = baseurl+'/customer/add-product-cart';
        let actionurl = $(this).data('actionurl');
        ...
        ({
            ...
            success: function(resp){  /* A function to be called if request succeeds */
                ...
                if(respData.responseCode == 200){
                    ...
                    $(_self).closest(".product_"+productid+"_cartBtn").html('<a href="javascript:void(0);" data-baseurl="'+baseurl+'" data-actionurl="'+addProductFromCartUrl+'" data-productid="'+productid+'" data-customerid="'+customerid+'" data-lang="'+locale+'" class="brand-btn-add-cart addToCart">'+AddToCart+'</a>');
                }else{
                    swal({title: "", text: respData.responseMessage, type: "error"});
                }
            }
    ...
    $("section").on("click",".addProdToWshlst", function(e) { 
        e.preventDefault();
        let _self = $(this);
    ...
    $("section").on("click",".removeProdFromWshlst", function(e) { 
        e.preventDefault();
        let _self = $(this);
