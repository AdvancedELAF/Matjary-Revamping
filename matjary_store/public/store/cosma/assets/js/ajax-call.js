        ...
        ({
            ...
            success: function(resp){  /* A function to be called if request succeeds */
                ...
                if(respData.responseCode == 200){
                    ...
                    $("#product_"+productid+"_cartBtn").html('<a href="javascript:void(0);" data-baseurl="'+baseurl+'" data-actionurl="'+removeProductFromCartUrl+'" data-productid="'+productid+'" data-customerid="'+customerid+'" data-lang="'+locale+'" class="btn btn-primary brand-btn-black removeFromCart">'+RemoveFromCart+'</a>');
                }else{
                    swal({title: "", text: respData.responseMessage, type: "error"});
                }
            }
        ...
        ({
            ...
            success: function(resp){  /* A function to be called if request succeeds */
                ...
                if(respData.responseCode == 200){
                    swal.close();
                    $("#cartCount").text(respData.customerCartCount);                   
                    $("#product_"+productid+"_cartBtn").html('<a href="javascript:void(0);" data-baseurl="'+baseurl+'" data-actionurl="'+addProductFromCartUrl+'" data-productid="'+productid+'" data-customerid="'+customerid+'" data-lang="'+locale+'" class="btn btn-primary brand-btn-black addToCart">'+AddToCart+'</a>');
                }else{
                    swal({title: "", text: respData.responseMessage, type: "error"});
                }
            }
    ...
    $("#productCartBox").on("click",".addToWishlist", function() { 
        ...
        ({
            ...
            success: function(resp){  /* A function to be called if request succeeds */
                ...
                if(respData.responseCode == 200){
                    swal.close();
                    $("#product_"+productid+"_whishlistBtn").html('<a href="javascript:void(0);" data-baseurl="'+baseurl+'" data-actionurl="'+removeProductFromWishlistUrl+'" data-productid="'+productid+'" data-customerid="'+customerid+'" class="btn btn-primary brand-btn-black removeFromWishlist">'+RemoveFromWhishlist+'</a>');
                }else{
                    swal({title: "", text: respData.responseMessage, type: "error"});
                }
            }
        ...
        ({
            ...
            success: function(resp){  /* A function to be called if request succeeds */
                ...
                if(respData.responseCode == 200){
                    ...
                    swal.close();
                    $("#product_"+productid+"_whishlistBtn").html('<a href="javascript:void(0);" data-baseurl="'+baseurl+'" data-actionurl="'+addProductToWishlistUrl+'" data-productid="'+productid+'" data-customerid="'+customerid+'" data-lang="'+locale+'" class="btn btn-primary brand-btn-black addToWishlist">'+wishlist+'</a>');
                }else{
                    swal({title: "", text: respData.responseMessage, type: "error"});
                }
            }
                                ...
                                if(isCheckoutPage==1){
                                    ...
                                    $.each(customerAddressList,function(key, value){
                                        ...
                                        var html_content = '<div class="checkout-wrapper">'+
                                            ...
                                            '</div>'+
                                            '<p class="error1"></p>'+
                                            '<a href="javascript:void(0);" class="btn btn-secondary btn-sm brand-btn-black '+mrml+' editMyAddress" data-customerid="'+value.customer_id+'" data-actionurl="'+base_url+'/customer/edit-customer-deliver-address" data-id="'+value.id+'">'+EditBtn+'</a>'+
                                            '<a href="javascript:void(0);" class="btn btn-secondary btn-sm brand-btn-black-outline removeMyAddressbtn" id="rempveAddress" data-actionurl="'+base_url+'/customer/delete-customer-deliver-address" data-id="'+value.id+'" data-operation="delete"><i class="dw dw-delete-3"></i> '+DeleteBtn+'</a>'+
                                        '</div>';
