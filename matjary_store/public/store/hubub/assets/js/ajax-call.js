                                ...
                                if(isCheckoutPage==1){
                                    ...
                                    $.each(customerAddressList,function(key, value){
                                        ...
                                        var html_content = '<div class="checkout-wrapper">'+
                                            ...
                                            '<a href="javascript:void(0);" class="brand-btn removeMyAddressbtn" id="rempveAddress" data-actionurl="'+base_url+'/customer/delete-customer-deliver-address" data-id="'+value.id+'" data-operation="delete"><i class="dw dw-delete-3"></i> '+DeleteBtn+'</a>'+
                                        '</div>';
