...
<body style="list-style: none; text-decoration: none; padding: 0; margin: 0; background-color: #FAFAFA; display: grid; place-content: center; min-height: 100vh;">
    <div class="mail-wrap" style="width: 50%; margin:0% 24%; padding: 1.5rem;background-color: #FFFFFF;">
        ...
        <div style="font-family: sans-serif;">
            <h2 style="text-align: center; margin-top: 0; margin-bottom: 10px; color: #4BB543; border-bottom: 1px solid #dfdfdf; padding-bottom: 1rem;">Create Pickup Sucessfully</h2>
            <h3 style="margin-bottom: 10px;">Hi <?php echo 'Store Admin'; ?> ,</h3>
            <p style="line-height: 1.8; color: #000000; margin-bottom: 5px;">We are happy to help you!</p>
            <p style="line-height: 1.8; color: #000000; margin-bottom: 5px;">Create Pickup Successfully</p> 
            <p style="line-height: 1.8; color: #000000; margin-bottom: 5px;">Created Pickup ID : <?php echo $pickupId; ?></p>            
            <p>Team Matjary,</p>
            <div style="text-align: center; margin-top: 1rem; border-top: 5px solid #f5f5f5">
                <p style="margin-bottom: 5px;">Powered by <a href="<?php echo $supportEmail;?>" target="_blank style="text-decoration: none; color: #5294F7;"></a></p>
