...
<head>
    ...
    <title>Admin Response Mail On Contact Us Form</title>
</head>
<style>
    .mail-wrap {
        width: 400px;
    ...
    <div class="mail-wrap" style="width: 50%; margin:0% 24%; padding: 1.5rem;background-color: #FFFFFF;">
        ...
        <div style="font-family: sans-serif;">
            ...
            <div style="margin-top: 1rem; margin-bottom: 0">   
                <strong style="color: #5294F7;">Your Message:</strong>
            </div>
            <p style="line-height: 1.5; color: #000000; margin-bottom: 5px; margin-top: 8px; font-size: 13px;"><?php echo $massage; ?></p>
            <div style="margin-top: 1rem; margin-bottom: 0">   
