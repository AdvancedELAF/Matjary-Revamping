    ...
    <div class="page-header">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="title">
                    <h4><?php echo $language['Add Product Size']; ?></h4>
                </div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('admin'); ?>"><?php echo $language['Products']; ?></a></li>                        
                        <li class="breadcrumb-item active" aria-current="page"><?php echo $language['Add Product Size']; ?></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
            <div class="pd-20 card-box">
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <?php 
                        $attributes = ['name' => 'save_product_size_form', 'id' => 'save_product_size_form', 'autocomplete' => 'off']; 
                        echo form_open_multipart('admin/save-product-size',$attributes); 
                    ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-2">
                                ...
                                <input type="text" name="size" id="size" class="form-control" placeholder="<?php echo $language['Size Name']; ?>">
                            </div>
                        </div>
                    </div>
