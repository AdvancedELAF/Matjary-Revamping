...
<div class="min-height-200px">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo $language['Shipping Order']; ?></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="order-detail-table">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <td><?php echo isset($orderDetails['orderInfo']->created_at) ? $orderDetails['orderInfo']->created_at : 'NA'; ?></td>
    ...
    <div class="card-box pd-20 mb-30">
        <h5 class="h4 text-blue mt-3 mb-3"><?php echo $language['Items Details']; ?></h5>
        <div class="order-detail-table">
            <div class="table-responsive">
                <table class="table">
    ...
    <div class="row">
        <?php if (!isset($orderDetails['orderGiftCardInfo']) && empty($orderDetails['orderGiftCardInfo'])) { ?>
            <div class="col-lg-6">
                <div class="card-box pd-20 mb-30">
                    <h5 class="h4 text-blue mt-3 mb-3"><?php echo $language['Delivery Address']; ?></h5>
                    <div class="cart-total-wrapper">
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td class="cart-structure-name"><?php echo $language['Address']; ?></td>
                                        <td>
                                            <div class="cart-price">
                                                <?php echo isset($orderDetails['orderInfo']->address) ? $orderDetails['orderInfo']->address : 'NA'; ?>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="cart-structure-name"><?php echo $language['Country']; ?></td>
                                        <td>
                                            <div class="cart-price">
                                                <?php echo isset($orderDetails['orderInfo']->country_name) ? $orderDetails['orderInfo']->country_name : 'NA'; ?>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="cart-structure-name"><?php echo $language['State']; ?></td>
                                        <td>
                                            <div class="cart-price">
                                                <?php echo isset($orderDetails['orderInfo']->state_name) ? $orderDetails['orderInfo']->state_name : 'NA'; ?>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="cart-structure-name"><?php echo $language['City']; ?></td>
                                        <td>
                                            <div class="cart-price">
                                                <?php echo isset($orderDetails['orderInfo']->city_name) ? $orderDetails['orderInfo']->city_name : 'NA'; ?>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
        ...
        <div class="col-lg-6">
            <div class="card-box pd-20 mb-30">
                ...
                <a href="javascript:window.print();" class="btn btn-primary btn-lg btn-block"><?php echo $language['Download/Invoice']; ?></a>
            </div>
            <div class="text-right mb-4">
                <a href="<?php echo base_url('admin/ship-orders'); ?>" class="btn btn-secondary"><?php echo $language['Back to orders']; ?></a>
            </div>
        </div>
    </div>
</div>
