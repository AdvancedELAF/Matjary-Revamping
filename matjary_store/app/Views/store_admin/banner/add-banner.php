    ...
    <div class="page-header">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="title">
                    <h4><?php echo $language['Add Banner']; ?></h4>
                </div>
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo $language['Add Banner']; ?></li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mb-30">
            <div class="pd-20 card-box">
                ...
                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <?php 
                        $attributes = ['name' => 'save_banner_form', 'id' => 'save_banner_form', 'autocomplete' => 'off']; 
                        echo form_open_multipart('admin/save-banner',$attributes); 
                    ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                                <div class="mb-2">
                                    <label>URL</label>
                                    <input type="url" class="form-control" placeholder="URL" id="banner_url" name="banner_url"  >
                                </div>
                        </div>
                    </div>
