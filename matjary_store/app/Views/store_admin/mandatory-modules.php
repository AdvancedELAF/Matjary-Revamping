            ...
            <div class="pd-20 card-box">
                <?php if($is_generalsetting_modules_filled==0){ ?>
                    <div class="alert alert-warning">
                        <strong><?php echo $language['Warning!']; ?></strong> <?php echo $language['General Setting Module Mandatory to Fill for use Store Admin Pannel.']; ?> <a href="<?php echo base_url('admin/general-settings'); ?>" class="btn btn-primary btn-sm"><?php echo $language['Click here to fill']; ?>.</a>
                    </div>
                <?php } ?>
                <?php if($is_paymentsetting_modules_filled==0){ ?>
                    <div class="alert alert-warning">
                        <strong><?php echo $language['Warning!']; ?></strong> <?php echo $language['Payment Setting Module Mandatory to Fill for use Store Admin Pannel.']; ?> <a href="<?php echo base_url('admin/payment-settings'); ?>" class="btn btn-primary btn-sm"><?php echo $language['Click here to fill']; ?>.</a>
                    </div>
                <?php } ?>
                <?php if($is_shippingsetting_modules_filled==0){ ?>
                    <div class="alert alert-warning">
                        <strong><?php echo $language['Warning!']; ?></strong> <?php echo $language['Shipping Setting Module Mandatory to Fill for use Store Admin Pannel.']; ?>  <a href="<?php echo base_url('admin/shipping-settings'); ?>" class="btn btn-primary btn-sm"><?php echo $language['Click here to fill']; ?>.</a> <button class="btn btn-primary btn-sm" data-actionurl="<?php echo base_url('set-default-shipping-setting'); ?>" id="setDefaultShipStngs">Use Default</button>
                    </div>
                <?php } ?>
            </div>
        </div>
