            ...
            <?php if($is_paymentsetting_modules_filled==1){ ?>
                <?php if($is_shippingsetting_modules_filled==1){ ?>
                    <div class="col-md-12 col-sm-12">
                        <div class="card-box pd-20 mb-30">
                            <div class="mand-box">
                                <p class="text-success"><?php echo $language['Congratulations! You are ready to go']; ?></p>
                                <p class="text-success"><?php echo $language['We are delighted to inform you that you have successfully completed all the necessary modules and you can now access your store admin panel.']; ?></p>
                                <p class="text-success"><?php echo $language['You can now start adding products, product categories, brands and more to your ecommerce website. This is a great way to get your store up and running quickly.']; ?></p>
                                <p class="text-success"><?php echo $language['If you run into any issues while setting up or running your store, feel free to reach out to us at any time. We are always here to help!']; ?></p>
                            </div>
                        </div>
                    </div>
                <?php } ?>
