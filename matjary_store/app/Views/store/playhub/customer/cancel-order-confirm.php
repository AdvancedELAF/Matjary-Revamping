    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        <select name="cancel_reason" id="cancel_reason" class="brand-select">
                    ...
                    <div class="col-md-6">
                        <div class="back-btn">
                            <a href="javascript:void(0);" class="brand-btn-orange" id="cnfrmCnclBtn" data-cancelreason="Cancel Reason" data-actionurl="<?php echo base_url('customer/cancel-order'); ?>" data-orderid="<?php echo isset($orderDetails['orderInfo']->id)?$orderDetails['orderInfo']->id:''; ?>" data-customerid="<?php echo isset($ses_custmr_id)?$ses_custmr_id:''; ?>" ><?php echo $language['Confirm & Cancel']; ?></a>
            ...
            <div class="col-md-12" id="otherReason" style="display:none;" >
                <div class="row">
                    <div class="col-md-6">                        
                        <textarea name="other_reason" id="other_reason" rows="2" maxlength ="52" style="width:100%;" class="brand-input" placeholder="<?php echo $language['Enter Other Reason']; ?>..."></textarea>
                    </div>               
                </div>
