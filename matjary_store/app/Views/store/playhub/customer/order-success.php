        ...
        <div class="section-spacing">
            ...
            <!--/div><--Print Div End-->
                ...
                <div class=" text-center">
                    <a class="brand-btn-orange hide-from-printer" href="<?php echo base_url('product/products'); ?>"><?php echo $language['Continue shopping']; ?></a>
                    <a class="brand-btn-black hide-from-printer" href="<?php echo base_url('customer/my-orders'); ?>"><?php echo $language['Go to my orders']; ?></a>                    
                    <a class="brand-btn-orange hide-from-printer" href="javascript:void(0);" onclick="printPageArea('printableArea')" ><?php echo $language['Download/Invoice']; ?></a>
                </div>
        </div>
    </div>
</section>
