...
<body style="list-style: none; text-decoration: none; padding: 0; margin: 0; background-color: #FAFAFA; display: grid; place-content: center; min-height: 100vh;">
 <div class="mail-wrap">
        ...
        <div style="font-family: sans-serif;">
            ...
            <h3 style="margin-bottom: 10px;">Hi, <?php echo $cusName; ?></h3>
            <p style="line-height: 1.8; color: #000000; margin-bottom: 5px;"> Your refund has been approved!</p>
            <p style="line-height: 1.8; color: #000000; margin-bottom: 5px;">We’re pleased to inform you that your refund request has been approved successfully. The amount of <?php echo $refundedAmount; ?> SAR will be credited to your <?php echo $paymentMethod; ?> within the next 3-5 business days.</p>
            <p style="line-height: 1.8; color: #000000; margin-bottom: 5px;">We hope this experience was up to your satisfaction and we’d love to have you back again soon.</p>
            <p style="line-height: 1.8; color: #000000; margin-bottom: 5px;">If you have any further queries, please feel free to reach out to us at any time.</p>
            <p style="line-height: 1.8; color: #000000; margin-bottom: 5px;">Thanks for your understanding,</p>
            <p>Regards,</p>
