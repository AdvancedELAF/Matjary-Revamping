...
<section>
    <div class=" section-spacing container <?php if($locale=='ar'){echo 'text-right';} ?>">
        ...
        <div class="row">
            ...
            <div class="col-lg-7">
                <div class="prod-main-detail">
                    ...
                    <p><span class="sale-amount-line"><?php echo $language['SAR']; ?> <?php echo isset($productDetails->retail_price)?number_format((float)$productDetails->retail_price, 2, '.', ''):''; ?></p>
                    <p><span class="strike-amount"><?php echo $language['SAR']; ?> <?php echo isset($productDetails->product_price)?number_format((float)$productDetails->product_price, 2, '.', ''):''; ?></p>
                    ...
                    <div class="prod-stock-count">
                        <h4><?php echo $language['Stock']; ?>: <?php if($productDetails->stock_quantity==0){echo'<span class="text-danger">'.$language['Out of Stock'].'</span>';}elseif($productDetails->stock_quantity <= $productDetails->threshold_quantity){echo '<span class="text-warning">'.$language['Only'].' '.$productDetails->stock_quantity.' '.$language['Units Left'].'</span>';}else{ echo '<span class="text-success">'.$language['Available'].'</span>'; } ?></h4>
                    </div>
                    ...
                    <div class="d-grid gap-2 d-md-block <?php if($locale=='ar'){echo 'text-right';} ?>" id="productCartBox">
                        <?php if(isset($ses_logged_in) && $ses_logged_in===true){ ?>
                            ...
                            <span id="product_<?php echo $productDetails->id; ?>_cartBtn">
                                <a href="javascript:void(0);" data-baseurl="<?php echo base_url(); ?>" data-actionurl="<?php echo $actionPrdctCarturl; ?>" data-productid="<?php echo $productDetails->id; ?>" data-customerid="<?php echo $ses_custmr_id; ?>"  data-lang="<?php echo $locale; ?>" class="brand-btn-add-cart <?php echo $actionCartBtnClass; ?>"><?php echo $anchorCartBtnText; ?></a> 
                            </span>
                            <span id="product_<?php echo $productDetails->id; ?>_whishlistBtn">
                                <a href="javascript:void(0);" data-baseurl="<?php echo base_url(); ?>" data-actionurl="<?php echo $actionWishlisturl; ?>" data-productid="<?php echo $productDetails->id; ?>" data-customerid="<?php echo $ses_custmr_id; ?>"  data-lang="<?php echo $locale; ?>" class="brand-btn-add-wishlist <?php echo $actionWishlistBtnClass; ?>"><?php echo $anchorWishlistBtnText; ?></a>
                            </span>
                            <?php if($productDetails->stock_quantity!=0){ ?>
                            <a href="javascript:void(0);" class="brand-btn-add-wishlist" data-actionurl="<?php echo base_url('customer/buy-product'); ?>" data-productid="<?php echo $productDetails->id; ?>" data-customerid="<?php echo $ses_custmr_id; ?>" id="buyProductBtn"><?php echo $language['Buy']; ?></a>
                            <?php } ?>
                        <?php }else{ ?> 
                            <a href="<?php echo base_url('customer/login'); ?>" class="brand-btn-add-cart"><?php echo $language['Add to Cart']; ?></a>
                            <a href="<?php echo base_url('customer/login'); ?>" class="brand-btn-add-wishlist"><?php echo $language['Wishlist']; ?></a>
                        ...
                        <div class="modal-dialog modal-dialog-centered brand-modal-dialog">
                            <div class="modal-content brand-modal-content">                   
                                ...
                                <div class="modal-body brand-modal-body">                                
                                        ...
                                        <div class="mb-2">
                                            <label brand-label text-orange ><?php echo $language['Rating']; ?><span class="required-mark">*</span></label>
                                        ...
                                        <div class="mb-2">
                                            <label class="brand-label text-orange" ><?php echo $language['Enter Feedback']; ?><span class="required-mark">*</span></label>
                                            <textarea class="brand-input" rows="3" id="feedback" name="feedback" maxlength="5002"><?php //echo isset($ProductFeedBackDetails[0]->feedback)?$ProductFeedBackDetails[0]->feedback:''; ?></textarea>
                                        </div>
                                        <div class="text-right">                                       
                                            <input type="submit" value="<?php echo $language['Submit']; ?>" class="brand-btn-orange">
                ...
                <div class="tab-content prod-main-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane prod-main-pane fade" id="pills-reviews" role="tabpanel" aria-labelledby="pills-reviews-tab">                      
                       <?php if(isset($GetProductFeedbacks) && !empty($GetProductFeedbacks)){
                            ...
                            <h6 class="prod-main-content-title"> <i> <?php echo $language['Review by']; ?> </i> <?php echo isset($GetProductFeedbacksData->name)?$GetProductFeedbacksData->name:''; ?>  on <?php echo isset($GetProductFeedbacksData->created_at)?date('d M Y',strtotime($GetProductFeedbacksData->created_at)):''; ?></h6>                            
                            <p><?php echo $ses_lang=='en' ? $GetProductFeedbacksData->feedback : $GetProductFeedbacksData->feedback_ar; ?></p>
                            <hr>
                       <?php  } }else{ ?>
                           <p><?php echo $language['No Reviews Available']; ?></p>
                       <?php } ?>                     
                    </div>
                </div>
            </div>
