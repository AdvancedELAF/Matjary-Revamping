                    ...
                    <div class="d-grid gap-2 d-md-block <?php if($locale=='ar'){echo 'text-right';} ?>" id="productCartBox">
                        <?php if(isset($ses_logged_in) && $ses_logged_in===true){ ?>
                            ...
                            <span id="product_<?php echo $productDetails->id; ?>_cartBtn">
                                <a href="javascript:void(0);" data-baseurl="<?php echo base_url(); ?>" data-actionurl="<?php echo $actionPrdctCarturl; ?>" data-productid="<?php echo $productDetails->id; ?>" data-customerid="<?php echo $ses_custmr_id; ?>"  data-lang="<?php echo $locale; ?>" class="btn btn-primary brand-btn <?php echo $actionCartBtnClass; ?>"><?php echo $anchorCartBtnText; ?></a> 
                            </span>
                            <span id="product_<?php echo $productDetails->id; ?>_whishlistBtn">
                                <a href="javascript:void(0);" data-baseurl="<?php echo base_url(); ?>" data-actionurl="<?php echo $actionWishlisturl; ?>" data-productid="<?php echo $productDetails->id; ?>" data-customerid="<?php echo $ses_custmr_id; ?>"  data-lang="<?php echo $locale; ?>" class="btn btn-primary brand-btn <?php echo $actionWishlistBtnClass; ?>"><?php echo $anchorWishlistBtnText; ?></a>
                            </span>
                            <?php if($productDetails->stock_quantity!=0){ ?>
                            <a href="javascript:void(0);" class="btn btn-primary brand-btn" data-actionurl="<?php echo base_url('customer/buy-product'); ?>" data-productid="<?php echo $productDetails->id; ?>" data-customerid="<?php echo $ses_custmr_id; ?>" id="buyProductBtn"><?php echo $language['Buy']; ?></a>
                            <?php } ?>
                        <?php }else{ ?> 
                            <a href="<?php echo base_url('customer/login'); ?>" class="btn btn-primary brand-btn"><?php echo $language['Add to Cart']; ?></a>
                            <a href="<?php echo base_url('customer/login'); ?>" class="btn btn-primary brand-btn"><?php echo $language['Wishlist']; ?></a>
