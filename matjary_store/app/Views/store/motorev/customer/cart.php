            ...
            <div class="col-md-6">
                <div class="promo-wrapper">
                    ...
                    <div class="promo-input">
                        ...
                        <a href="javascript:void(0);" class="btn btn-primary brand-btn float-right mt-3" id="couponCodeApplyBtn" data-customerid="<?php echo isset($ses_custmr_id)?$ses_custmr_id:''; ?>" data-actionurl="<?php echo base_url('customer/applied-coupon-code'); ?>"><?php echo $language['Apply']; ?></a>
                    </div>
