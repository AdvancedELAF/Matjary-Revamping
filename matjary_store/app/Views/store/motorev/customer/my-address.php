        ...
        <div class="row" id="deliveryAddressWrapper">
            ...
            <div class="col-md-4" >
                <div class="checkout-wrapper">
                    ...
                    <a href="javascript:void(0);" id="rempveAddress" data-baseurl="<?php echo base_url(); ?>" data-actionurl="<?php echo base_url('customer/delete-customer-deliver-address'); ?>" class="btn btn-secondary btn-sm brand-btn removeMyAddressbtn"   data-id="<?php echo $customerAddressData->id; ?>"><i class="dw dw-delete-3"></i> <?php echo $language['Delete']; ?></a>                   
                </div>
            </div>   
            <?php
                }
        ...
        <div class="row" id="addEditAddressFormRow">
            <div class="col-md-12">
                <div class="checkout-wrapper">
                    ...
                    <button type="submit" class="btn btn-primary brand-btn" id="saveUpdateBtn"><?php echo $language['Save']; ?></button>
                    <button type="reset" class="btn btn-primary brand-btn" id="resetMyAddressFormBtn"><?php echo $language['Reset']; ?></button>
                    <?php echo form_close(); ?>
                </div>
            </div>
        </div> 
