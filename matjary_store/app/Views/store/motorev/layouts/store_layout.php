...
<head>
    ...
    <!-- Motorev Stylesheet -->
    <?php if($ses_lang=='ar'){ ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/motorev-styles-ar.css" />
    <?php }elseif($ses_lang=='en'){?> 
    <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/motorev-styles.css" />
    <?php }else{ ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/motorev-styles-ar.css" />
    <?php } ?>
...
<body>
    ...
    <div class="cookie-box" id="CookieConsentBox">
        ...
        <div class="<?php echo ($locale == 'ar') ?'text-left':'text-right'; ?>">
            <button class="brand-btn-cookie" id="acceptCookie"><?php echo $language['Accept']; ?></button>
            <button class="brand-btn-cookie" id="declineCookie"><?php echo $language['Decline']; ?></button>
        </div>
    </div>
    <!-- COOKIE ENDS -->
</body>
