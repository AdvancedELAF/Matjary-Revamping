...
<body style="list-style: none; text-decoration: none; padding: 0; margin: 0; background-color: #FAFAFA; display: grid; place-content: center; min-height: 100vh;">
    <div class="mail-wrap" style="width: 50%; margin:0% 24%; padding: 1.5rem;background-color: #FFFFFF;">
        ...
        <div style="font-family: sans-serif;">
            <h2 style="text-align: center; margin-top: 0; margin-bottom: 10px; color: #4BB543; border-bottom: 1px solid #dfdfdf; padding-bottom: 1rem;">Cancel Pickup Sucessfully</h2>
            <h3 style="margin-bottom: 10px;">Hi <?php echo $supportEmail; ?> ,</h3>
            <p style="line-height: 1.8; color: #000000; margin-bottom: 5px;">Pickup Canceled Successfully.</p>  
            <p style="line-height: 1.8; color: #000000; margin-bottom: 5px;">Pickup ID : <?php echo $pickupId; ?></p>      
            <p>Regards,</p>
