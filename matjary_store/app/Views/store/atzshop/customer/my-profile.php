                    ...
                    <div class="mb-2">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="name" name="name" maxlength="26" value="<?php echo isset($customerDetails->name)?$customerDetails->name:''; ?>">
                            </div>
                            <div class="col-md-3">
                                    <div class="mb-2">
                            ...
                            <?php if(isset($customerDetails->profile_image) && !empty($customerDetails->profile_image)){ ?>
                                ...
                                <a href="javascript:void(0);" id="rempveProfileImage" data-baseurl="<?php echo base_url(); ?>" data-actionurl="<?php echo base_url('customer/remove-profile-picture'); ?>" data-customerid="<?php echo $ses_custmr_id; ?>" ><img src="https://atzshopp.sa-matjary.com/img/remove.png"></a>
                            <?php }else{ ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="address" id="address" rows="2" maxlength ="52" class="form-control" placeholder="<?php echo $language['Enter Address']; ?>..."><?php echo isset($customerDetails->address)?$customerDetails->address:''; ?></textarea>
                            </div>
                            <div class="col-md-3">
