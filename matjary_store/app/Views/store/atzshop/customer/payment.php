                        ...
                        <div class="col-md-6" id="gift_cart_payment_div" style="display: none;">
                            <div class="form-group">
                                <div class="promo-input">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary brand-btn mt-1" data-actionurl="<?php echo base_url('customer/apply-giftcard-code'); ?>" data-customerid="<?php echo isset($cartTotal['customer_id']) ? $cartTotal['customer_id'] : ''; ?>" data-totalprice="<?php echo isset($cartTotal['total_price']) ? $cartTotal['total_price'] : ''; ?>" id="applyGCCodeBtn"><?php echo $language['Apply']; ?></a>
                                </div>
