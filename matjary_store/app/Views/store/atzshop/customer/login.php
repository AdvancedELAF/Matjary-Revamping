        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="login-signup-wrapper">
                    <div class="mb-3">
                        <label class="form-label mb-2"><?php echo $language['Username']; ?> <span class="required-mark">*</span></label>
                        <input type="email" name="email" id="email" class="form-control"  placeholder="<?php echo $language['Username']; ?>*" <?php echo $language['Email']; ?>*>
                    </div>
                    <div class="mb-3">
