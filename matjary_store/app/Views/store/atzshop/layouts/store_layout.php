                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="footer-logo">
                            ...
                            <?php } else { ?>
                                <a href="<?php echo base_url('home'); ?>"><img src="<?php echo base_url('/store/'.$storeActvTmplName.'/assets/images/logo.png'); ?>" alt="Logo Image" class="img img-responsive" style="width:auto;min-width:100px;max-width:100px;height:auto;min-height:100px;max-height:100px;"></a>
                            <?php } ?>
                        </div>
