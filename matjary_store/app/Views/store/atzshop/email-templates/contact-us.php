...
<div class="mail-wrap" style="width: 50%; margin:0% 24%; padding: 1.5rem;background-color: #FFFFFF;">
        ...
        <div style="font-family: sans-serif;">
            <h2 style="text-align: center; margin-top: 0; margin-bottom: 10px; color: #4BB543; border-bottom: 1px solid #dfdfdf; padding-bottom: 1rem;">Contact Us</h2>
            <h3 style="margin-bottom: 10px;">Hi <?php echo $cusName; ?> ,</h3>
            <p style="line-height: 1.8; color: #000000; margin-bottom: 5px;">Thank you for contacting us, we are glad to here from you!</p>
            <p style="line-height: 1.8; color: #000000; margin-bottom: 5px;">This mail is to let you know, that we have received your email and one of our representative will contact you soon.</p>
            <p>Regards,</p>
            <p>Team <?php echo $storeName; ?></p>
            <div style="text-align: center; margin-top: 1rem; border-top: 5px solid #f5f5f5">
                <p style="margin-bottom: 5px;">Powered by <a href="<?php echo base_url('home'); ?>" target="_blank" style="text-decoration: none; color: #5294F7;"><?php echo $name; ?></a></p>
