            ...
            <div class="col-lg-8">
                <div class="prod-main-detail <?php if($locale=='ar'){echo 'text-right';} ?>">
                    ...
                    <div class="d-grid gap-2 d-md-block">
                        ...
                        <button type="submit" class="btn btn-primary brand-btn-black" id="buyGiftCardSbmtBtn" ><?php echo $language['Buy']; ?></button>
                        <?php }else{ ?>
                            <a href="<?php echo base_url('customer/login'); ?>" class="btn btn-primary brand-btn-black"><?php echo $language['Buy']; ?></a>
                        <?php } ?>
                    </div>
                    <?php echo form_close(); ?>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="feedback-wrapper">
                                    ...
                                    <div class="modal-footer">
                                        <button class="btn btn-primary brand-btn-black" type="submit"><?php echo $language['Save']; ?></button>  
