...
<head>
    ...
    <!-- Cosma Stylesheet -->
    <?php if($ses_lang=='ar'){ ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/cosma-styles-ar.css" />
    <?php }elseif($ses_lang=='en'){?> 
    <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/cosma-styles.css" />
    <?php }else{ ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/cosma-styles-ar.css" />
    <?php } ?>
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="footer-title">
                            ...
                            <p><?php echo $language['Address']; ?>: <?php echo isset($storeSettingInfo->address) ? $storeSettingInfo->address : ''; ?></p>
                            <p><?php echo $language['Email']; ?>: <a href="mailto:"><?php echo isset($storeSettingInfo->support_email) ? $storeSettingInfo->support_email : ''; ?></a></p>
                            <p><?php echo $language['Call Us']; ?>: <a href="tel:"><?php echo isset($storeSettingInfo->contact_no) ? $storeSettingInfo->contact_no : ''; ?></a></p>
                        </div>
                    </div>
                    <div class="col-lg-4">
    ...
    <div class="cookie-box" id="CookieConsentBox">
        ...
        <div class="<?php echo ($locale == 'ar') ?'text-left':'text-right'; ?>">
            <button class="btn btn-primary brand-btn-black" id="acceptCookie"><?php echo $language['Accept']; ?></button>
            <button class="btn btn-primary brand-btn-black-outline" id="declineCookie"><?php echo $language['Decline']; ?></button>
        </div>
    </div>
    <!-- COOKIE ENDS -->
</body>
