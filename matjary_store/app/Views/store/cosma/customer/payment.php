        ...
        <div class="row">
            <div class="col-md-6 col-lg-8">
                ...
                <div class="checkout-wrapper">
                        ...
                        <div class="col-md-6" id="gift_cart_payment_div" style="display: none;">
                            <div class="form-group">
                                <div class="promo-input">
                                    ...
                                    <a href="javascript:void(0);" class="btn btn-primary brand-btn-black" data-actionurl="<?php echo base_url('customer/apply-giftcard-code'); ?>" data-customerid="<?php echo isset($cartTotal['customer_id']) ? $cartTotal['customer_id'] : ''; ?>" data-totalprice="<?php echo isset($cartTotal['total_price']) ? $cartTotal['total_price'] : ''; ?>" id="applyGCCodeBtn"><?php echo $language['Apply']; ?></a>
                                </div>
                    ...
                    <button type="submit" class="btn btn-primary btn-sm brand-btn-black" id="payBtn"><?php echo $language['Pay']; ?></button>
                    <a href="<?php echo base_url('/home'); ?>" class="btn btn-secondary btn-sm brand-btn-black-outline"><?php echo $language['Cancel']; ?></a>
                    <?php echo form_close(); ?>
                </div>
            </div>
