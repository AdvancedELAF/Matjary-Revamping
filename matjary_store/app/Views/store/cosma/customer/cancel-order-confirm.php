...
<div class="page-bar <?php if($locale=='ar'){echo 'text-right';} ?>">
    <div class="container">
        <div class="section-title">
            <h4><?php echo $language['Order Cancel Confirmation']; ?></h4>
        </div>
    </div>
</div>
<!-- PAGE BAR ENDS -->
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="back-btn">
                            <a href="javascript:void(0);" class="btn btn-primary brand-btn-black-outline " id="cnfrmCnclBtn" data-cancelreason="Cancel Reason" data-actionurl="<?php echo base_url('customer/cancel-order'); ?>" data-orderid="<?php echo isset($orderDetails['orderInfo']->id)?$orderDetails['orderInfo']->id:''; ?>" data-customerid="<?php echo isset($ses_custmr_id)?$ses_custmr_id:''; ?>"><?php echo $language['Confirm & Cancel']; ?></a>
                            <a href="<?php echo base_url('customer/my-orders'); ?>" class="btn btn-primary brand-btn-black-outline " ><?php echo $language['Back to orders']; ?></a>
                        </div>
                    </div>                   
                </div>                
            </div>
