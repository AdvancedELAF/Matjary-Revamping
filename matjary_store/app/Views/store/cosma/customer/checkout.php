                ...
                <span id="deliveryAddressWrapper">
                    ...
                    ?>
                        <div class="checkout-wrapper">
                            ...
                            <p class="error1"></p>
                            <a href="javascript:void(0);" class="btn btn-secondary btn-sm brand-btn-black editMyAddress" data-customerid="<?php echo isset($ses_custmr_id) ? $ses_custmr_id : ''; ?>" data-actionurl="<?php echo base_url('customer/edit-customer-deliver-address'); ?>" data-id="<?php echo $customerAddressData->id; ?>" data-lang="<?php echo $locale; ?>"><?php echo $language['Edit']; ?></a>
                            <a href="javascript:void(0);" class="btn btn-secondary btn-sm brand-btn-black-outline removeMyAddressbtn" id="rempveAddress" data-actionurl="<?php echo base_url('customer/delete-customer-deliver-address'); ?>" data-id="<?php echo $customerAddressData->id; ?>" data-operation="delete"><i class="dw dw-delete-3"></i> <?php echo $language['Delete']; ?></a>
                        </div>
                    <?php
                        }
                    }else{
            ...
            <div class="col-md-6 col-lg-5">
                ...
                <div class="ship-comp">
                    ...
                    <div class="text-right">
                        <button class="btn btn-primary btn-sm brand-btn-black btn-block" id="proceed_checkout_btn"><?php echo $language['Submit']; ?></button>
