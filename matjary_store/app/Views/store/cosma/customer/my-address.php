...
<section class="section-spacing <?php if($locale=='ar'){echo 'text-right';} ?>">
    <div class="container">
        <div class="section-title mb-3">
            <h4><?php echo $language['My Address']; ?></h4>
        </div>
        <div class="row" id="deliveryAddressWrapper">
            ...
            <div class="col-md-4" >
                <div class="checkout-wrapper">
                    ...
                    <p class="error1"></p>
                    <button class="btn btn-secondary btn-sm brand-btn-black-outline editMyAddress" data-customerid="<?php echo isset($ses_custmr_id)?$ses_custmr_id:''; ?>" data-actionurl="<?php echo base_url('customer/edit-customer-deliver-address'); ?>" data-id="<?php echo $customerAddressData->id; ?>"><?php echo $language['Edit']; ?></button>
                    <a href="javascript:void(0);" id="rempveAddress" data-baseurl="<?php echo base_url(); ?>" data-actionurl="<?php echo base_url('customer/delete-customer-deliver-address'); ?>" class="btn btn-secondary btn-sm brand-btn-black-outline removeMyAddressbtn"   data-id="<?php echo $customerAddressData->id; ?>"><i class="dw dw-delete-3"></i> <?php echo $language['Delete']; ?></a>                   
                </div>
            </div>   
            <?php
                }
                ...
                <div class="checkout-wrapper">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <textarea name="address" id="address" rows="2" maxlength ="52" style="width:100%;" class="form-control" placeholder="<?php echo $language['Enter Deliver Address']; ?>..."></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <input type="text" class="numberonly form-control" name="zipcode" id="zipcode" data-error=".error1" placeholder="<?php echo $language['Enter Zipcode']; ?>.." minlength="5" maxlength="6">
                                </div>
                                <span class="error1"></span>
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary btn-sm brand-btn-black" id="saveUpdateBtn"><?php echo $language['Save']; ?></button>
                    <button type="reset" class="btn btn-secondary btn-sm brand-btn-black-outline" id="resetMyAddressFormBtn"><?php echo $language['Reset']; ?></button>
                    <?php echo form_close(); ?>
                </div>
            </div>
        </div> 
