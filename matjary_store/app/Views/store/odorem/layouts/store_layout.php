...
<head>
    ...
    <!-- Odorem Stylesheet -->
    <?php if($ses_lang=='ar'){ ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/odorem-styles-ar.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/responsive-ar.css" />
    <?php }elseif($ses_lang=='en'){?> 
    <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/odorem-styles.css" />
...
<body>
                ...
                <ul class="nav-content-list">
                    ...
                    <li class="nav-content-item">
                        <a class="nav-content-link" href="<?php echo base_url('customer/cart'); ?>">
                            ...
                            <?php } else { ?>
                                <i class="icofont-cart" id="cartCount"></i>
                            <?php } ?>
                        </a>
                    </li>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="footer-title">
                        <div class="section-title">
                            <h2><?php echo $language['Important Links']; ?></h2>
                        </div>
                    </div>
                    ...
                    <ul class="footer-list">
                        ...
                        <li>
                            <i class="icofont-dotted-right"></i>
                            <a href="<?php echo base_url('terms-and-conditions'); ?>"><?php echo $language['Terms & Condition']; ?></a>
                        </li>
                        <li>
                            <i class="icofont-dotted-right"></i>
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <ul class="footer-list">
                        <li>
                            ...
                            <a href="#"><?php echo isset($storeSettingInfo->address) ? $storeSettingInfo->address : ''; ?></a>
                        </li>
                        <li>
                    ...
                    <ul class="footer-social">
                        <li>
                            <a <?php if(isset($storeSettingInfo->social_instagram_link) && !empty($storeSettingInfo->social_instagram_link)){echo 'href="'.$storeSettingInfo->social_instagram_link.'" target="_blank"'; }else{ 'href="#"'; } ?> ><i class="icofont-instagram"></i></a>                        
                        </li>

                        <li>
                            <a <?php if(isset($storeSettingInfo->social_fb_link) && !empty($storeSettingInfo->social_fb_link)){echo 'href="'.$storeSettingInfo->social_fb_link.'" target="_blank"'; }else{ 'href="#"'; } ?> ><i class="icofont-facebook"></i></a>
                    </li>

                    <li>
                            <a <?php if(isset($storeSettingInfo->social_twitter_link) && !empty($storeSettingInfo->social_twitter_link)){echo 'href="'.$storeSettingInfo->social_twitter_link.'" target="_blank"'; }else{ 'href="#"'; } ?> ><i class="icofont-twitter"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="cookie-box" id="CookieConsentBox">
        ...
        <div class="<?php echo ($locale == 'ar') ?'text-left':'text-right'; ?>">
            ...
            <button class="btn btn-primary brand-btn" id="declineCookie"><?php echo $language['Decline']; ?></button>
        </div>
    </div>
    <!-- COOKIE ENDS -->
</body>
