...
<section class="ot-banner-bg">
    <div class="container">
        <div class="section-title text-center">
            <h2><i class="icofont-star-alt-1"></i> <?php echo $language['Cart']; ?> <i class="icofont-star-alt-1"></i> </h2>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="cart-action-buttons">
            <div class="d-grid gap-2 d-md-block ms-auto">
                <a href="javascript:void(0);" class="btn btn-primary brand-btn" id="emptyCart" data-actionurl="<?php echo base_url('customer/empty-cart'); ?>" data-customerid="<?php echo $ses_custmr_id; ?>"><?php echo $language['Empty Cart']; ?></a>
                <a href="<?php echo base_url('product/products'); ?>" class="btn btn-primary brand-btn" type="button"><?php echo $language['Continue Shopping']; ?></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="section-title">
                    <h2><?php echo $language['Cart total']; ?> <i class="icofont-star-alt-1"></i></h2>
                </div>
                ...
                <div class="checkout-btn">
                    <button type="submit" class="btn btn-primary brand-btn" id="proceedToCheckoutBtn"><?php echo $language['Proceed to checkout']; ?></button>
                </div>
            </div>
            <div class="col-md-6">
                <div class="promo-wrapper">
                    <div class="section-title mb-4">
                        <h2><?php echo $language['Promo coupon code']; ?> <i class="icofont-star-alt-1"></i></h2>
                    </div>
                    <div class="promo-input">
                        <input class="form-control" type="text" name="coupon_code" id="coupon_code" placeholder="<?php echo $language['Enter Promo Code']; ?>">
                        <a href="javascript:void(0);" class="btn btn-primary brand-btn float-<?php echo $ses_lang == 'en'?'right':'left'; ?> mt-3" id="couponCodeApplyBtn" data-customerid="<?php echo isset($ses_custmr_id)?$ses_custmr_id:''; ?>" data-actionurl="<?php echo base_url('customer/applied-coupon-code'); ?>"><?php echo $language['Apply']; ?></a>
                    </div>
...
<section class="section-spacing <?php if($locale=='ar'){echo 'text-right';} ?>">
    <div class="container">
        ...
        <a href="<?php echo base_url('product/products'); ?>" class="btn btn-primary brand-btn"><?php echo $language['Continue Shopping']; ?></a>
    </div>
</section>
