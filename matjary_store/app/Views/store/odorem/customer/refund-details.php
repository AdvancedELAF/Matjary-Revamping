...
<section class="ot-banner-bg <?php if($locale=='ar'){echo 'text-right';} ?>">
    <div class="container">
        <div class="section-title text-center">
            <h2><i class="icofont-star-alt-1"></i> <?php echo $language['My Orders']; ?> <i class="icofont-star-alt-1"></i> </h2>
        </div>
    </div>
</section>
<!-- PAGE BAR ENDS -->
...
<section class="section-spacing <?php if($locale=='ar'){echo 'text-right';} ?>">
    <div class="container">
        <div class="section-title mb-3"><h4><?php echo $language['Order Information']; ?></h4></div>
            ...
            <div class="back-btn">
                <a href="<?php echo base_url('customer/my-refund-request'); ?>" class="btn btn-primary brand-btn" ><?php echo $language['Back']; ?></a>
            </div>
        </div>
</section>
