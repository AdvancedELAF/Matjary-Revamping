...
<section class="ot-banner-bg <?php if($locale=='ar'){echo 'text-right';} ?>">
    <div class="container">
        <div class="section-title text-center">
            <h2><i class="icofont-star-alt-1"></i> <?php echo $language['Order Cancel Confirmation']; ?> <i class="icofont-star-alt-1"></i> </h2>
        </div>
    </div>
</section>
<!-- PAGE BAR ENDS -->
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="back-btn">
                            <a href="javascript:void(0);" class="btn btn-primary brand-btn " id="cnfrmCnclBtn" data-cancelreason="Cancel Reason" data-actionurl="<?php echo base_url('customer/cancel-order'); ?>" data-orderid="<?php echo isset($orderDetails['orderInfo']->id)?$orderDetails['orderInfo']->id:''; ?>" data-customerid="<?php echo isset($ses_custmr_id)?$ses_custmr_id:''; ?>"><?php echo $language['Confirm & Cancel']; ?></a>
