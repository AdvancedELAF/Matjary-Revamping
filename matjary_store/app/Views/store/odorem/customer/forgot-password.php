...
<section class="ot-banner-bg <?php if($locale=='ar'){echo 'text-right';} ?>">
    <div class="container">
        <div class="section-title text-center">
            <h2><i class="icofont-star-alt-1"></i> <?php echo $language['Forgot Password']; ?> <i class="icofont-star-alt-1"></i> </h2>
        </div>
    </div>
            ...
            <div class="col-md-6">
                <div class="forgot-pass-wrapper">
                    <div class="section-tagline">
                        <h6><?php echo $language['Request for a new Password']; ?><i class="icofont-star-alt-1"></i></h6>
                    </div>
                    <?php 
