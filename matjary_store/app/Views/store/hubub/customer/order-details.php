...
<section class="section-spacing <?php if($locale=='ar'){echo 'text-right';} ?>">
    ...
    <div id="printableArea"><!--Print Div Start-->
        ...
        <div class="back-btn">
            <a href="javascript:void(0);" onclick="printPageArea('printableArea')" class="g-brand-btn" ><?php echo $language['Download/Invoice']; ?></a>
            <a href="<?php echo base_url('customer/my-orders'); ?>" class="brand-btn" ><?php echo $language['Back to orders']; ?></a>
        </div>
    </div>
</section>
