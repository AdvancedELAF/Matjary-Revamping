...
<section class="ot-banner">
    <div class="container">
        <div class="page-title">
            <h1><?php echo $language['Add A New Address']; ?></h1>
        </div>
    </div>
</section>
<!-- CHECKOUT STARTS -->
                ...
                <div class="address-wrapper mb-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <textarea name="address" id="address" maxlength="52" rows="2" style="width:100%;" class="brand-textarea" placeholder="<?php echo $language['Enter Deliver Address']; ?>..."></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-6" >
                ...
                ?>
                    <div class="checkout-wrapper">
                        ...
                        <a href="javascript:void(0);" class="brand-btn removeMyAddressbtn" id="rempveAddress" data-actionurl="<?php echo base_url('customer/delete-customer-deliver-address'); ?>" data-id="<?php echo $customerAddressData->id; ?>" data-operation="delete"><i class="dw dw-delete-3"></i> <?php echo $language['Delete']; ?></a>
                    </div>
                <?php
                    }
                }else{
            ...
            <div class="col-md-6 col-lg-6">
                ...
                <div class="ship-comp">
                    ...
                    <div class="text-<?php echo $ses_lang == 'en'?'right':'left'; ?> mt-1">
                        <button class="g-brand-btn" id="proceed_checkout_btn"><?php echo $language['Submit']; ?></button>
                    </div>
                </div>
            </div>
        </div>
