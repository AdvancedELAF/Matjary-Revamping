...
<section class="section-spacing <?php if($locale=='ar'){echo 'text-right';} ?>">
    <div class="container">  
        <div class="order-table-count">
            ...
            <table class="data-table table nowrap table-striped" id="viewAllCustomerOrderList">
                <thead>
                    <tr>
                        <th scope="col">#</th>
        ...
        <a href="<?php echo base_url('customer/my-account'); ?>" class="brand-btn mx-auto "><?php echo $language['Back']; ?></a> 
    </div>
</section>
