            ...
            <div class="col-md-6">
                <div class="forgot-pass-wrapper">
                    ...
                    <?php }else{ ?>
                        ...
                        <div class="mb-3">
                            <input type="password" name="password" id="password" class="brand-input" placeholder="<?php echo $language['Set new Password']; ?>*">
                        </div>
                        <div class="mb-3">
                            <input type="password" name="cnf_password" id="cnf_password" class="brand-input" placeholder="<?php echo $language['Confirm New Password']; ?>*">
                        </div>
                        <div class="d-grid gap-2 d-md-block">
                            <button type="reset" class="btn btn-primary brand-btn"><?php echo $language['Cancel']; ?></button>
