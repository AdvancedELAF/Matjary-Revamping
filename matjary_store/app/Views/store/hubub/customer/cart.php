    ...
    <div class="container">
        ...
        <div class="cart-action-buttons">
            <div class="d-grid gap-2 d-md-block ms-auto">
                <a href="javascript:void(0);" class="g-brand-btn" id="emptyCart" data-actionurl="<?php echo base_url('customer/empty-cart'); ?>" data-customerid="<?php echo $ses_custmr_id; ?>"><?php echo $language['Empty Cart']; ?></a>
                <a href="<?php echo base_url('product/products'); ?>" class="brand-btn" type="button"><?php echo $language['Continue Shopping']; ?></a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="col-md-6 col-lg-8">
                ...
                <div class="checkout-btn mt-3">
                    <button type="submit" class="brand-btn" id="proceedToCheckoutBtn"><?php echo $language['Proceed to checkout']; ?></button>
                </div>
            </div>
