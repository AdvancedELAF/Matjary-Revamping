    ...
    <div class="container">
        <div>
                                ...
                                <?php }elseif(isset($orderDetails['orderGiftCardInfo']) && !empty($orderDetails['orderGiftCardInfo'])){ ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><h6><?php echo $language['Grand total']; ?> <?php echo isset($orderDetails['orderGiftCardInfo']->giftcard_amount)?$orderDetails['orderGiftCardInfo']->giftcard_amount:''; ?></h6></td>
                                            <td><h6><?php echo $language['Grand total']; ?> <?php echo isset($orderDetails['orderGiftCardInfo']->total_price)?$orderDetails['orderGiftCardInfo']->total_price:''; ?></h6></td>
                                        </tr>
                                    </tbody>
                                <?php } ?>
                            </table>
            ...
            <div class="d-grid gap-2 d-md-block text-center">
                <button class="g-brand-btn hide-from-printer mb-1">
                    <a href="<?php echo base_url('product/products'); ?>"><?php echo $language['Continue shopping']; ?></a>
                </button>
                <button class="brand-btn hide-from-printer mb-1">
