...
<head>
    ...
    <!-- Cosma Stylesheet -->
    <?php if($ses_lang=='ar'){ ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/hubub-styles-ar.css" />
    <?php }elseif($ses_lang=='en'){?> 
    <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/hubub-styles.css" />
    <?php }else{ ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/hubub-styles-ar.css" />
    <?php } ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-4">
                        ...
                        <ul class="footer-links">
                            <li>
                                <a href="<?php echo base_url('abouts-us'); ?>">
                                    <p><?php echo $language['About Us']; ?></p>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('terms-and-conditions'); ?>">
                                    <p><?php echo $language['Terms & Conditions']; ?></p>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('contact-us'); ?>">
                                    <p><?php echo $language['Contact Us']; ?></p>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('faq/faqs'); ?>">
                                    <p><?php echo $language['FAQ']; ?></p>
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-4 col-lg-4">
                        ...
                        <ul class="footer-social-media">
                            <li>
                            <a <?php if (isset($storeSettingInfo->social_fb_link) && !empty($storeSettingInfo->social_fb_link)) {
                            ...
                            <li>
                            <a <?php if (isset($storeSettingInfo->social_instagram_link) && !empty($storeSettingInfo->social_instagram_link)) {
                            ...
                            <li>
                            <a <?php if (isset($storeSettingInfo->social_twitter_link) && !empty($storeSettingInfo->social_twitter_link)) {
                            ...
                            <li>
                            <a <?php if (isset($storeSettingInfo->social_youtube_link) && !empty($storeSettingInfo->social_youtube_link)) {
                            ...
                            <li>
                            <a <?php if (isset($storeSettingInfo->social_linkedin_link) && !empty($storeSettingInfo->social_linkedin_link)) {
