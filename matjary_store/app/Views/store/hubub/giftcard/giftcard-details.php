...
<section class="ot-banner">
    <div class="container">
        <div class="page-title">
            <h1><?php echo $language['Giftcard Details']; ?></h1>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="prod-main-detail">
                    ...
                    <div class="prod-detail-price"><?php echo $language['SAR']; ?> <input type="text" name="gc_amount" id="gc_amount" value="1000" maxlength="5" placeholder="Enter Gift Card Amount" class="brand-input w-30"><h6 id="gcAmountErrMsg"></h6></div>
                    ...
                    <div class="d-grid gap-2 d-md-block">
                        ...
                        <button type="submit" class="g-brand-btn" id="buyGiftCardSbmtBtn" ><?php echo $language['Buy']; ?></button>
                        <?php }else{ ?>
                            <a href="<?php echo base_url('customer/login'); ?>" class="g-brand-btn"><?php echo $language['Buy']; ?></a>
                        <?php } ?>
                    </div>
                    <?php echo form_close(); ?>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="feedback-wrapper">
                                    <div class="mb-2">
                                        ...
                                        <select class="custom-select brand-select" id="ratting" name="ratting">
