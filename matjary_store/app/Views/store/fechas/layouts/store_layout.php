...
<head>
    ...
    <!-- fechas-Stylesheet -->
    <?php if ($ses_lang == 'ar') { ?>
        <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/fechas-styles-ar.css" />
    <?php } elseif ($ses_lang == 'en') { ?>
        <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/fechas-styles.css" />
    <?php } else { ?>
        <link rel="stylesheet" href="<?php echo base_url(); ?>/store/<?php echo $storeActvTmplName; ?>/assets/css/fechas-styles-ar.css" />
    <?php } ?>
...
<body>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pd-5">
                    ...
                    <button class="g-brand-btn" id="acceptCookie"><?php echo $language['Accept']; ?></button>
                    <button type="button" class="g-brand-btn" id="declineCookie" data-dismiss="modal"><?php echo $language['Decline']; ?></button>
                </div>
            </div>
        </div>
    </div> -->
        ...
        <div class="header-container">
            ...
            <label class="open-search" for="open-search">
                ...
                <div class="search">
                    ...
                    <ul class="list-group <?php if ($locale == 'ar') { echo 'text-right'; } ?>"></ul>
                </div>
            </label>
            <!-- // search -->
                    ...
                    <li class="nav-content-item">
                        <a class="nav-content-link" href="<?php echo base_url('customer/cart'); ?>">
                            <?php if (isset($ses_logged_in) && $ses_logged_in === true) { ?>
                                ...
                                ?>
                                <i class="icofont-basket" id="cartCount"><?php echo $cartCount; ?></i>
                            <?php } else { ?>
                                <i class="icofont-basket" id="cartCount"></i>
                            <?php } ?>
                        </a>
                    </li>
                    <?php if (isset($lang_session) && $lang_session === true) { ?>
                        <?php if ($ses_lang == 'ar') { ?>
                            <li class="nav-content-item"><a href="javascript:void(0);" data-actionurl="<?php echo base_url('/language'); ?>" data-lang="en" id="languageChange" class="nav-content-link lang-switch-text">EN</a></li>
                        <?php } elseif ($ses_lang == 'en') { ?>
                            <li class="nav-content-item"><a href="javascript:void(0);" data-actionurl="<?php echo base_url('/language'); ?>" data-lang="ar" id="languageChange" class="nav-content-link lang-switch-text">AR</a></li>
                        <?php } ?>
                    <?php } else { ?>
                        <li class="nav-content-item"><a href="javascript:void(0);" data-actionurl="<?php echo base_url('/language'); ?>" data-lang="en" id="languageChange" class="nav-content-link lang-switch-text">EN</a></li>
                    <?php } ?>
            ...
            <nav class="all-category-nav">
                <label class="open-menu-all" for="open-menu-all">
                    ...
                    <ul class="all-category-list">
                                    ...
                                    <?php if (isset($prodCat->subcat) && !empty($prodCat->subcat)) { ?>
                                        <div class="category-second-list">
                                            ...
                                            <?php foreach ($prodCat->subcat as $prodCatSub) { ?>
                                                <li class="category-second-item"><a href="<?php echo base_url('category/category-product-list/' . $prodCatSub->id); ?>"><?php echo $prodCatSub->category_name; ?></a></li>   
                                            <?php } ?>                                         
                                            </ul>                                    
                                        </div>
                                    <?php } ?>
                        ...
                        ?>
                        <li class="all-category-list-item"><a href="<?php echo base_url('category/all-categories'); ?>" class="all-category-list-link"><?php echo $language['All Categories']; ?><i class="fas fa-angle-right"></i></a></li>
                    </ul>
                </label>
            </nav>
    ...
    <?php if (isset($pageTitle) && in_array($pageTitle, $allowedDatatablePagesAry)) { ?>
        ...
        <!--DataTable js end-->
    <?php } ?>
    <?php //echo '<pre>'; print_r($AboutUsInfo); ?>
    <footer>
        <div id="footer-one">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="footer-subtitle">
                            <h3><?php echo $language['Email & Call']; ?>:</h3>
                        </div>
                        <div class="footer-link">
                            <a href="mailto:"><?php echo isset($storeSettingInfo->support_email) ? $storeSettingInfo->support_email : ''; ?></a>
                        </div>
                        <div class="footer-link">
                            <a href="tel:"><?php echo isset($storeSettingInfo->contact_no) ? $storeSettingInfo->contact_no : ''; ?></a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        ...
                        <ul class="footer-list">
                            <li><a href="<?php echo base_url('abouts-us'); ?>"><?php echo $language['About Us']; ?></a></li>
                            <li><a href="<?php echo base_url('terms-and-conditions'); ?>"><?php echo $language['Terms & Conditions']; ?></a></li>
                            <li><a href="<?php echo base_url('contact-us'); ?>"><?php echo $language['Contact Us']; ?></a></li>
                            <li><a href="<?php echo base_url('faq/faqs'); ?>"><?php echo $language['FAQ']; ?></a></li>
                        </ul>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="footer-title">
        ...
        <div id="footer-two">
            <div class="footer-credit">
                <p><?php echo $language['Powered By']; ?> <a href="https://matjary.in">Matjary</a></p>
            </div>
        </div>
    </footer>
    <!-- COOKIE STARTS -->
    <div class="cookie-box" id="CookieConsentBox">
        ...
        <div class="<?php echo ($locale == 'ar') ?'text-left':'text-right'; ?>">
            <button class="g-brand-btn" id="acceptCookie"><?php echo $language['Accept']; ?></button>
            <button class="lb-brand-btn" id="declineCookie"><?php echo $language['Decline']; ?></button>
        </div>
    </div>
    <!-- COOKIE ENDS -->
</body>
