                ...
                <div class="prod-main-detail">
                    ...
                    <div class="prod-detail-price">
                        <div class="d-flex align-items-center">
                            <p class="mb-0"><?php echo $language['SAR']; ?></p>
                            <input class="brand-input w-50 m-2" type="text" name="gc_amount" id="gc_amount" value="1000" maxlength="5" placeholder="<?php echo $language['Enter Gift Card Amount']; ?>">
