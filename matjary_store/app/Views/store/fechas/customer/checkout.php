                ...
                <div class="checkout-wrapper mb-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <textarea name="address" id="address" maxlength="52" rows="2" style="width:100%;" class="brand-input" placeholder="<?php echo $language['Enter Deliver Address']; ?>..."></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <button type="reset" class="g-brand-btn" id="resetMyAddressFormBtn"><?php echo $language['Reset']; ?></button>
                ...
                <span id="deliveryAddressWrapper">
                    ...
                    ?>
                        <div class="checkout-wrapper">
                            ...
                            <p class="error1"></p>
                            <a href="javascript:void(0);" class="g-brand-btn editMyAddress" data-customerid="<?php echo isset($ses_custmr_id) ? $ses_custmr_id : ''; ?>" data-actionurl="<?php echo base_url('customer/edit-customer-deliver-address'); ?>" data-id="<?php echo $customerAddressData->id; ?>" data-lang="<?php echo $locale; ?>"><?php echo $language['Edit']; ?></a>
                            <a href="javascript:void(0);" class="g-brand-btn removeMyAddressbtn" id="rempveAddress" data-actionurl="<?php echo base_url('customer/delete-customer-deliver-address'); ?>" data-id="<?php echo $customerAddressData->id; ?>" data-operation="delete"><i class="dw dw-delete-3"></i> <?php echo $language['Delete']; ?></a>
                        </div>
                    <?php
                        }
                    }else{
                    ?>
                        <div class="checkout-wrapper">
                           <label> <h6 class="delivery-name"><?php echo $language['No Delivery Address Available']; ?>.</h6></label>
                        </div>
                    <?php
                    }
                    ?>
            ...
            <div class="col-md-6 col-lg-5">
                ...
                <div class="ship-comp">
                    ...
                    <div class="text-right">
                        <button class="g-brand-btn btn-block mt-2" id="proceed_checkout_btn"><?php echo $language['Submit']; ?></button>
                        <?php echo form_close(); ?>
                    </div>
                </div>
            </div>
