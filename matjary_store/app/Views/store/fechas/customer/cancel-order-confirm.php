    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        <select name="cancel_reason" id="cancel_reason" class="brand-input">
                    ...
                    <div class="col-md-6">
                        <div class="back-btn">
                            <a href="javascript:void(0);" class="db-brand-btn" id="cnfrmCnclBtn" data-cancelreason="Cancel Reason" data-actionurl="<?php echo base_url('customer/cancel-order'); ?>" data-orderid="<?php echo isset($orderDetails['orderInfo']->id)?$orderDetails['orderInfo']->id:''; ?>" data-customerid="<?php echo isset($ses_custmr_id)?$ses_custmr_id:''; ?>" ><?php echo $language['Confirm & Cancel']; ?></a>
