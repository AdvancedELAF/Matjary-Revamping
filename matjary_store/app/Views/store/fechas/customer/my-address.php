        ...
        <div class="row" id="deliveryAddressWrapper">
            ...
            <div class="col-md-4" >
                <div class="checkout-wrapper mb-3">
                    ...
                    <a href="javascript:void(0);" id="rempveAddress" data-baseurl="<?php echo base_url(); ?>" data-actionurl="<?php echo base_url('customer/delete-customer-deliver-address'); ?>" class="g-brand-btn removeMyAddressbtn" type="button"  data-id="<?php echo $customerAddressData->id; ?>"><i class="dw dw-delete-3"></i> <?php echo $language['Delete']; ?></a>                   
                </div>
            </div>   
            <?php
                }
                ...
                <div class="checkout-wrapper">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <textarea name="address" id="address" rows="2" maxlength ="52" style="width:100%;" class="brand-input" placeholder="<?php echo $language['Enter Deliver Address']; ?>..."></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
