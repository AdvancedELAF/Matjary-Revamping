...
<section class="section-spacing <?php if($locale=='ar'){echo 'text-right';} ?>">
    <div class="container">
        <div class="section-title text-center mb-4"><h2><?php echo $language['Already a User? Log in']; ?>!</h2></div>
        <div class="row">
            ...
            <div class="col-md-6">
               <div class="login-signup-wrapper">
                    ...
                    <input type="email" name="email" id="email" class="brand-input mb-0" placeholder="<?php echo $language['Email']; ?>*">
                    <input type="password" name="password" id="password" class="brand-input mb-0 mt-3" placeholder="<?php echo $language['Password']; ?>*">
                    <div class="d-grid gap-2 d-md-block mt-3">                      
                        <button type="reset" class="g-brand-btn"><?php echo $language['Reset']; ?></button>
                        <button type="submit" class="g-brand-btn"><?php echo $language['Login']; ?></button>
                    </div>
