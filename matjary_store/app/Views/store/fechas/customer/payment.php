    ...
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="checkout-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" id="gift_cart_payment_div" style="display: none;">
                            <div class="form-group">
                                <div class="promo-input d-md-flex">
                                    ...
                                    <a href="javascript:void(0);" class="g-brand-btn m-1" data-actionurl="<?php echo base_url('customer/apply-giftcard-code'); ?>" data-customerid="<?php echo isset($cartTotal['customer_id']) ? $cartTotal['customer_id'] : ''; ?>" data-totalprice="<?php echo isset($cartTotal['total_price']) ? $cartTotal['total_price'] : ''; ?>" id="applyGCCodeBtn"><?php echo $language['Apply']; ?></a>
                                </div>
                        ...
                        <a href="<?php echo base_url('/home'); ?>" class="g-brand-btn" type="button"><?php echo $language['Cancel']; ?></a>
                    <?php echo form_close(); ?>
                </div>
            </div>
            ...
            <div class="col-md-12 col-lg-4">
                ...
                <div class="checkout-wrapper">
                    <div class="row">
                        <label class="col-md-6 col-lg-6 col-sm-6 col-form-label"><?php echo $language['Cart Amount']; ?>:</label>
                    ...
                    <?php } else { ?>
                    <div class="row">
                        <label class="col-md-6 col-lg-6 col-sm-6 col-form-label"><?php echo $language['Delivery']; ?>:</label>
                        <div class="col-md-6 col-lg-6 col-sm-6 text-right">
                    ...
                    <div class="cart-value text-center">
                        <h4><label><?php echo $language['Total Amount']; ?> : <?php echo $language['SAR']; ?> <?php echo isset($cartTotal['total_price']) ? $cartTotal['total_price'] : '0'; ?></label></h4>
                    </div>
                </div>
            </div>
        </div>
