    ...
    <div class="container">    
                ...
                <table class="table table-striped">
                    ...
                    <tbody id="cartItemsTbody">
                        ...
                        <tr class="cartItemsTr">
                            ...
                            <td>
                                <input type="text" name="product_qty[]" id="product_qty_<?php echo $productId; ?>" data-productid="<?php echo $productId; ?>" data-actionurl="<?php echo base_url('single-product-details'); ?>" class="product_qty numberonly brand-input p-1" value="1" maxlength="3">
                            </td>
                            <td>
        ...
        <div class="cart-action-buttons">
            <div class="d-grid gap-2 d-md-block ms-auto">
                <a href="javascript:void(0);" class="g-brand-btn" id="emptyCart" type="button" data-actionurl="<?php echo base_url('customer/empty-cart'); ?>" data-customerid="<?php echo $ses_custmr_id; ?>"><?php echo $language['Empty Cart']; ?></a>
                <a href="<?php echo base_url('product/products'); ?>" class="db-brand-btn" type="button"><?php echo $language['Continue Shopping']; ?></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-8">
                        ...
                        <table class="table table-striped">
                                ...
                                <input type="hidden" name="customerid" id="customerid" value="<?php echo isset($ses_custmr_id)?$ses_custmr_id:''; ?>">
                                    <tr>
                                        ...
                                        <td><div class="cart-price"><h5><?php echo $language['SAR']; ?> <span id="subtotal_span"><?php if($cartItemChekedTrue==true){ echo isset($cartTotal['subtotal'])?number_format((float)$cartTotal['subtotal'], 2, '.', ''):0.00; }else{echo '0.00';} ?></span></h5></div></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="cart-price"><h5><?php echo $language['SAR']; ?> <span id="total_price_span"><?php if($cartItemChekedTrue==true){ echo isset($cartTotal['total_price'])?number_format((float)$cartTotal['total_price'], 2, '.', ''):0.00; }else{echo '0.00';} ?></span></h5></div></td>
                ...
                <div class="checkout-btn">
                    <button type="submit" class="db-brand-btn" id="proceedToCheckoutBtn"><?php echo $language['Proceed to checkout']; ?></button>
                </div>
            </div>            
            <div class="col-md-6 col-lg-4">
                <div class="promo-wrapper">
                    ...
                    <div class="promo-input <?php echo $locale=='en'?'text-left':'text-right'; ?>">
                        ...
                        <div class="text-<?php echo $locale=='en'?'right':'left'; ?>">
                            <a href="javascript:void(0);" class="g-brand-btn mt-1" id="couponCodeApplyBtn" data-customerid="<?php echo isset($ses_custmr_id)?$ses_custmr_id:''; ?>" data-actionurl="<?php echo base_url('customer/applied-coupon-code'); ?>"><?php echo $language['Apply']; ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="section-spacing <?php if($locale=='ar'){echo 'text-right';} ?>">
    <div class="container">
        ...
        <a href="<?php echo base_url('product/products'); ?>" class="db-brand-btn"><?php echo $language['Continue Shopping']; ?></a>
    </div>
</section>
<?php } ?>
<?php $this->endSection(); ?>