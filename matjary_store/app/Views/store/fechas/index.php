            ...
            ?>
                    <div class="carousel-item <?php echo (!$i ? 'active' : ''); ?>">
                        ...
                        <div class="carousel-content">
                            ...
                            <?php if (isset($value->banner_url) && !empty($value->banner_url)) { ?>
                                <a target="_blank" href="<?php echo isset($value->banner_url) ? $value->banner_url : ''; ?>" class="g-brand-btn"><?php echo $language['Shop Now']; ?></a>
                            <?php } ?>
                        </div>
                    </div>
                <?php
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-content">
                        ...
                        <button class="g-brand-btn"><?php echo $language['Shop Now']; ?></button>
                    </div>
                </div>
        ...
        <section class="section-spacing <?php if ($locale == 'ar') { echo 'text-right'; } ?>">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6">
                        <a href="<?php echo base_url('product/products'); ?>" class="db-brand-btn float-right <?php if ($locale == 'ar') { echo 'float-left'; } else { echo 'float-right'; } ?>"><?php echo $language['View All']; ?></a>
                    </div>
                </div>
        ...
        <section class="section-spacing <?php if ($locale == 'ar') { echo 'text-right'; } ?>">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6">
                        <a href="<?php echo base_url('product/products'); ?>" class="db-brand-btn <?php if ($locale == 'ar') { echo 'float-left'; } else { echo 'float-right'; } ?>"><?php echo $language['View All']; ?></a>
                    </div>
                </div>
                <div class="carousel-wrapper mt-3">
        ...
        <section class="section-spacing <?php if ($locale == 'ar') { echo 'text-right'; } ?>">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6">
                        <a href="<?php echo base_url('category/all-categories'); ?>" class="db-brand-btn <?php if ($locale == 'ar') { echo 'float-left'; } else { echo 'float-right'; } ?>"><?php echo $language['View All']; ?></a>
                    </div>
                </div>
                                    ...
                                    <div class="prod-wrapper">
                                        ...
                                        <div class="prod-detail text-center">
                                            ...
                                            <div class="offer-badge">
                                                <span><?php echo isset($productData->discount_per) ? $productData->discount_per : ''; ?> <?php echo $language['% Discount']; ?></span>
                                            </div>
                                            <div class="wishlist">
                                                <i class="icofont-heart <?php echo $press; ?> <?php echo $wishlistActnClass; ?>" data-productid="<?php echo $productData->id; ?>" data-customerid="<?php echo isset($ses_custmr_id) ? $ses_custmr_id : ''; ?>"></i>
                                            </div>
...
<?php } else { ?>
    <section class="section-spacing">
        <div class="container">
            <div class="row">
                <p>
                <h4><?php echo $language['No Product Found']; ?></h4>
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="section-spacing <?php if ($locale == 'ar') { echo 'text-right'; } ?>">
        <div class="container">
            <div class="row">
                ...
                <div class="col-6">
                    <button class="db-brand-btn <?php if ($locale == 'ar') { echo 'float-left'; } else { echo 'float-right'; } ?>"><?php echo $language['View All']; ?></button>
                </div>
            </div>
            <div class="carousel-wrapper mt-3">
