                ...
                <div class="col-lg-7">
                    <div class="prod-main-detail">
                        ...
                        <div class="prod-detail-price">
                            <p><?php echo $language['SAR']; ?> <?php echo isset($productDetails->product_price) ? number_format((float)$productDetails->product_price, 2, '.', '') : ''; ?></p>
                        ...
                        <div class="d-grid gap-2 d-md-block <?php if ($locale == 'ar') {
                            ...
                            <?php if (isset($ses_logged_in) && $ses_logged_in === true) { ?>
                                ...
                                <span id="product_<?php echo $productDetails->id; ?>_cartBtn">
                                    <a href="javascript:void(0);" data-baseurl="<?php echo base_url(); ?>" data-actionurl="<?php echo $actionPrdctCarturl; ?>" data-productid="<?php echo $productDetails->id; ?>" data-customerid="<?php echo $ses_custmr_id; ?>" data-lang="<?php echo $locale; ?>" class="g-brand-btn <?php echo $actionCartBtnClass; ?>"><?php echo $anchorCartBtnText; ?></a>
                                </span>
                                <span id="product_<?php echo $productDetails->id; ?>_whishlistBtn">
                                    <a href="javascript:void(0);" data-baseurl="<?php echo base_url(); ?>" data-actionurl="<?php echo $actionWishlisturl; ?>" data-productid="<?php echo $productDetails->id; ?>" data-customerid="<?php echo $ses_custmr_id; ?>" data-lang="<?php echo $locale; ?>" class="db-brand-btn <?php echo $actionWishlistBtnClass; ?>"><?php echo $anchorWishlistBtnText; ?></a>
                                </span>
                                <?php if ($productDetails->stock_quantity != 0) { ?>
                                    <a href="javascript:void(0);" class="db-brand-btn" data-actionurl="<?php echo base_url('customer/buy-product'); ?>" data-productid="<?php echo $productDetails->id; ?>" data-customerid="<?php echo $ses_custmr_id; ?>" id="buyProductBtn"><?php echo $language['Buy']; ?></a>
                                <?php } ?>
                            <?php } else { ?>
                                <a href="<?php echo base_url('customer/login'); ?>" class="g-brand-btn"><?php echo $language['Add to Cart']; ?></a>
                                <a href="<?php echo base_url('customer/login'); ?>" class="db-brand-btn"><?php echo $language['Wishlist']; ?></a>
                                <a href="<?php echo base_url('customer/login'); ?>" class="db-brand-btn"><?php echo $language['Buy']; ?></a>
                            <?php } ?>
                        ...
                        <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="feedback-wrapper modal-body pd-5">
                                        <div class="mb-2">
