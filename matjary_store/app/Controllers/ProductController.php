...
class ProductController extends BaseController
{
    ...
    public function save_product(){
                    ...
                    if(isset($_FILES['image']['name']) && !empty($_FILES['image']['name'])){ 
                        if(isset($_POST['retail_price']) && !empty($_POST['retail_price'])){
                            if(isset($_POST['wholesale_price']) && !empty($_POST['wholesale_price'])){
                               // if(isset($_POST['discount_per']) && !empty($_POST['discount_per'])){
                                        ...
                                        if(isset($_POST['stock_quantity']) && !empty($_POST['stock_quantity'])){
                                            if(isset($_POST['order_limit_quantity']) && !empty($_POST['order_limit_quantity'])){
                                                if(isset($_POST['threshold_quantity']) && !empty($_POST['threshold_quantity'])){
                                                    ...
                                                    //     }else{
                                                    //         $resp['responseCode'] = 404;
                                                    //         $resp['responseMessage'] = 'Product Tags Are Required.';
                                                    //         return json_encode($resp); exit;
                                                    //     }
                                                    // }else{
                                                    //     $resp['responseCode'] = 404;
                                                    //     $resp['responseMessage'] = 'Product Keywords Are Required.';
                                                    //     return json_encode($resp); exit;
                                                    // }
                                ...
                                //     }else{
                                //         $resp['responseCode'] = 404;
                                //         $resp['responseMessage'] = $this->ses_lang=='en'?'Sales Tax Is Required.':'مطلوب ضريبة المبيعات.';
                                //         return json_encode($resp); exit;
                                //     }
                                // }else{
                                //     $resp['responseCode'] = 404;
                                //     $resp['responseMessage'] = $this->ses_lang=='en'?'Discount Percentage % Is Required.':'النسبة المئوية للخصم مطلوب.';
                                //     return json_encode($resp); exit;
                                // }
                            }else{
                                $resp['responseCode'] = 404;
        ...
        //         }else{
        //             $resp['responseCode'] = 404;
        //             $resp['responseMessage'] = 'Long Description Is Required.';
        //             return json_encode($resp); exit;
        //         }
        //     }else{
        //         $resp['responseCode'] = 404;
        //         $resp['responseMessage'] = 'Short Description Is Required.';
        //         return json_encode($resp); exit;
        //     }
        // }else{
        //     $resp['responseCode'] = 404;
