                    ...
                    <div class="contact-form">
                        ...
                        <input type="hidden" name="user_id" value="<?php echo isset($loggedInUsrData['id'])?$loggedInUsrData['id']:''; ?>" />       
                            <div class="form-wrapper">
                                ...
                                <?php }else{ ?>
                                <a href="modal" class="btn btn-primary btn-lg brand-btn-pink float-right mt-4 wow" data-toggle="modal" data-target="#modal" class="edit-avatar">Contact Information</i></a>
                                <?php } ?>
                            </div>
                        </form>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content invoice-modal-content">
            <div class="modal-header invoice-modal-header">
                <h5 class="modal-title invoice-modal-title" id="exampleModalLabel">Customer Enquiry</h5>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="invoice-wrapper">
                                    <p>To Submit Your Enquiry Ticket You need to <a href="<?php echo base_url('login'); ?>">Login</a> or <a href="<?php echo base_url('register'); ?>">Register Now</a> .</p>
                                    <p>if you dont want to register, you can mail us at <a href="support@matjary.com">support@matjary.com</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
