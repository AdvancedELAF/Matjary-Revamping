...
<div class="mail_content">
    <h4 style="margin-bottom: 10px; color: #8D4FDE">Hello <?php echo $cont_name; ?>,</h4> 
    <p>Thank you for submitting your enquiry ticket. We are pleased to inform you that it has been successfully submitted and our support team is now looking into it.</p>
