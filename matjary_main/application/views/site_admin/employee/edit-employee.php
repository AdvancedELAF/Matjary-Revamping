        ...
        <!-- /.content-header -->
          <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <form method="POST" action="<?php echo base_url('update-employee'); ?>" name="update_employee" id="update_employee" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">                                   
                                <div class="form-group">
									<label>State </label>
									<?php //echo '<pre>'; print_r($stateList); ?>
