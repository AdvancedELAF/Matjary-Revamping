...
<div class="mail_content">
    ...
    <table style="border-collapse: collapse; width: 100%; margin-bottom: 1rem; text-align: left; display: block; overflow-x: auto;"> 
        ...
        <tr>
            ...
            <td style="border: 1px solid #DDDDDD; padding: 8px;"><a href="<?php echo $set_pass; ?>" target="_blank" style="text-decoration: none; color: #5294F7; font-size: 12px;">click to set store admin password</a> (Ignore if already set.)</td>
        </tr>
    </table>
</div>
