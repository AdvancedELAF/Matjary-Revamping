                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $this->lang->line('SAR'); ?> 0.00</td>
                                    </tr>
                                    <tr class="total-row">
                                        <td></td>
                                        <td><?php echo $this->lang->line('user-acc-txt-40'); ?></td>
                                        <td>
                                            <?php echo $this->lang->line('SAR'); ?> <?php echo isset($subtotal) ? $subtotal : ''; ?>
                                            <input type="hidden" name="plan_total_price" value="<?php echo isset($subtotal) ? $subtotal : ''; ?>">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
